 ...
 * @author d.storti
 */
public class MissionOrderTest extends BasicTest<MissionOrder, MissionOrderService> {

	@Override
	@BeforeClass
	public void setUp() {
		super.setUp();
		service = new MissionOrderService(clientApi);
		ws_rights = "R"; //D
	}
	...
	@Override
	protected MissionOrder initObject() {
