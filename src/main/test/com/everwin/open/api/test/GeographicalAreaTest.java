...
import fr.everwin.open.api.services.geographicalareas.GeographicalAreaService;

/**
 * @author d.storti
 */
public class GeographicalAreaTest extends BasicTest<GeographicalArea, GeographicalAreaService> {
	...
	public void setUp() {
		super.setUp();
		service = new GeographicalAreaService(clientApi);
		ws_rights = "R";
	}
	...
	@Override
	protected GeographicalArea initObject() {
