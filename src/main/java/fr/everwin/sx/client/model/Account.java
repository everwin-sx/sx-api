...
public class Account {
  ...
  **/
  ...
  public Account vats(List<VatDataLink> vats) {
    this.vats = vats;
    return this;
  }

  public Account addVatsItem(VatDataLink vatsItem) {
    if (this.vats == null) {
  ...
  **/
  ...
  public List<VatDataLink> getVats() {
    return vats;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VATS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVats(List<VatDataLink> vats) {
    this.vats = vats;
  }
