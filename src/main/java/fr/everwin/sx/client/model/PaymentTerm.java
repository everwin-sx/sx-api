...
@JsonPropertyOrder({
  ...
  PaymentTerm.JSON_PROPERTY_METHOD_SENT_TO_EINVOICING,
...
public class PaymentTerm {
  ...
  /**
   * Indicates the method sent to E-invoicing of the payment term. 10 : Cash, 20 : Cheque, 30 : Credit transfer (includes SEPA credit transfer for CHORUSPRO), 42 : Payment to bank, 48 : Bank card, 49 : Direct debit (includes SEPA direct debit for CHORUSPRO), 57 : Payment Method Already Agreed Upon by the Parties, 58 : SEPA Transfer (not used for CHORUSPRO: code 30), 59 : SEPA Direct Debit (not used for CHORUSPRO: code 49), 97 : Carry forward
   */
  public enum MethodSentToEinvoicingEnum {
    NUMBER_10(10),
    ...
    MethodSentToEinvoicingEnum(Integer value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static MethodSentToEinvoicingEnum fromValue(Integer value) {
      for (MethodSentToEinvoicingEnum b : MethodSentToEinvoicingEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_METHOD_SENT_TO_EINVOICING = "methodSentToEinvoicing";
  private MethodSentToEinvoicingEnum methodSentToEinvoicing;
  ...
  **/
  ...
  public PaymentTerm methodSentToEinvoicing(MethodSentToEinvoicingEnum methodSentToEinvoicing) {
    this.methodSentToEinvoicing = methodSentToEinvoicing;
    return this;
  }

   /**
   * Indicates the method sent to E-invoicing of the payment term. 10 : Cash, 20 : Cheque, 30 : Credit transfer (includes SEPA credit transfer for CHORUSPRO), 42 : Payment to bank, 48 : Bank card, 49 : Direct debit (includes SEPA direct debit for CHORUSPRO), 57 : Payment Method Already Agreed Upon by the Parties, 58 : SEPA Transfer (not used for CHORUSPRO: code 30), 59 : SEPA Direct Debit (not used for CHORUSPRO: code 49), 97 : Carry forward
   * @return methodSentToEinvoicing
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_METHOD_SENT_TO_EINVOICING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public MethodSentToEinvoicingEnum getMethodSentToEinvoicing() {
    return methodSentToEinvoicing;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METHOD_SENT_TO_EINVOICING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMethodSentToEinvoicing(MethodSentToEinvoicingEnum methodSentToEinvoicing) {
    this.methodSentToEinvoicing = methodSentToEinvoicing;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, paymentTerm.id) &&
        ...
        Objects.equals(this.methodSentToEinvoicing, paymentTerm.methodSentToEinvoicing) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, settlementType, label, code, extraDays, extraMonths, endOfMonth, carryForwardDate, entities, visibility, methodSentToEinvoicing, debitMode, debitDate, hashCodeNullable(frequency), dueNumber, dayOfTheMonth, extraData);
  }
  ...
  public String toString() {
    ...
    sb.append("    methodSentToEinvoicing: ").append(toIndentedString(methodSentToEinvoicing)).append("\n");
