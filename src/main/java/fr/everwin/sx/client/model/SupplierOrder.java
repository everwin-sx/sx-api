...
public class SupplierOrder {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, validationStep, code, supplier, contact, entity, financialEntity, project, issuer, supplierAccount, creationDate, deliveryDate, supplierReference, estimateReference, currency, totalWithoutVat, deliveryAddress, deliveryStatus, state, comment, updatedOnTime, createdOnTime, extraData);
  }
