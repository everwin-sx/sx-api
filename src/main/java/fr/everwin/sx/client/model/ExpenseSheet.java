...
@JsonPropertyOrder({
  ...
  ExpenseSheet.JSON_PROPERTY_TOTAL_INCLUDING_TAXES,
...
public class ExpenseSheet {
  ...
  public static final String JSON_PROPERTY_TOTAL_INCLUDING_TAXES = "totalIncludingTaxes";
  ...
  public ExpenseSheet(
    ...
    @JsonProperty(JSON_PROPERTY_TOTAL_INCLUDING_TAXES) Double totalIncludingTaxes, 
  ...
  **/
  ...
  public Double getTotalToPay() {
   ...
   /**
   * Total including taxes of the expense sheet
   * @return totalIncludingTaxes
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TOTAL_INCLUDING_TAXES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, expenseSheet.id) &&
        ...
        Objects.equals(this.totalIncludingTaxes, expenseSheet.totalIncludingTaxes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, validationStep, code, employee, creationDate, advance, totalToPay, totalIncludingTaxes, entity, financialEntity, settlementDate, nbDaysLunch, distanceTravelled, comment, currency, createdOnTime, createdOnPeriod, updatedOnTime, updatedBy, lastComment, hasValidationHistory, access, extraData);
  }
  ...
  public String toString() {
    ...
    sb.append("    totalIncludingTaxes: ").append(toIndentedString(totalIncludingTaxes)).append("\n");
