...
@JsonPropertyOrder({
  ...
  Project.JSON_PROPERTY_SELLER_STRUCTURE,
  Project.JSON_PROPERTY_BUYER_STRUCTURE,
  Project.JSON_PROPERTY_VALIDATOR_STRUCTURE,
  Project.JSON_PROPERTY_ROLE,
  Project.JSON_PROPERTY_PROCESS,
  Project.JSON_PROPERTY_CONTRACT_NUMBER,
  Project.JSON_PROPERTY_MARKET_NUMBER,
  Project.JSON_PROPERTY_COMMITMENT_NUMBER,
  Project.JSON_PROPERTY_EFFECTIVE_DATE,
  Project.JSON_PROPERTY_SUBCONTRACTORS,
  Project.JSON_PROPERTY_JOINTCONTRACTORS,
...
public class Project {
  ...
  private CompanyAccountDataLink account;
  ...
  public static final String JSON_PROPERTY_SUBCONTRACTORS = "subcontractors";
  private List<CompanyDataLink> subcontractors;

  public static final String JSON_PROPERTY_JOINTCONTRACTORS = "jointcontractors";
  private List<CompanyDataLink> jointcontractors;
  ...
  **/
  ...
  public Project account(CompanyAccountDataLink account) {
  ...
  **/
  ...
  public CompanyAccountDataLink getAccount() {
    return account;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAccount(CompanyAccountDataLink account) {
    this.account = account;
  }
  ...
  **/
  ...
  public Project sellerStructure(SellerStructureDataLink sellerStructure) {
  ...
  **/
  ...
  public Project buyerStructure(EInvoicingStructureDataLink buyerStructure) {
  ...
  **/
  ...
  public Project validatorStructure(EInvoicingStructureDataLink validatorStructure) {
  ...
  **/
  ...
  public Project role(Integer role) {
    this.role = role;
    return this;
  }
  ...
  **/
  ...
  public Project process(Integer process) {
  ...
  **/
  ...
  public Project contractNumber(String contractNumber) {
  ...
  **/
  ...
  public Project marketNumber(String marketNumber) {
    this.marketNumber = marketNumber;
    return this;
  }

   /**
   * Market number of the project
   * @return marketNumber
  **/
  @jakarta.annotation.Nullable
  ...
  public Project commitmentNumber(String commitmentNumber) {
    this.commitmentNumber = commitmentNumber;
    return this;
  }

   /**
   * Commitment number of the project
  ...
  **/
  ...
  public Project effectiveDate(java.time.LocalDateTime effectiveDate) {
  ...
  **/
  ...
  public Project subcontractors(List<CompanyDataLink> subcontractors) {
    this.subcontractors = subcontractors;
    return this;
  }

  public Project addSubcontractorsItem(CompanyDataLink subcontractorsItem) {
    if (this.subcontractors == null) {
      this.subcontractors = new ArrayList<>();
    }
    this.subcontractors.add(subcontractorsItem);
    return this;
  }

   /**
   * Link to the subcontractors of the project
   * @return subcontractors
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUBCONTRACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<CompanyDataLink> getSubcontractors() {
    return subcontractors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBCONTRACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubcontractors(List<CompanyDataLink> subcontractors) {
    this.subcontractors = subcontractors;
  }


  public Project jointcontractors(List<CompanyDataLink> jointcontractors) {
    this.jointcontractors = jointcontractors;
    return this;
  }

  public Project addJointcontractorsItem(CompanyDataLink jointcontractorsItem) {
    if (this.jointcontractors == null) {
      this.jointcontractors = new ArrayList<>();
    }
    this.jointcontractors.add(jointcontractorsItem);
    return this;
  }

   /**
   * Link to the jointcontractors of the project
   * @return jointcontractors
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_JOINTCONTRACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<CompanyDataLink> getJointcontractors() {
    return jointcontractors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_JOINTCONTRACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setJointcontractors(List<CompanyDataLink> jointcontractors) {
    this.jointcontractors = jointcontractors;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, project.id) &&
        ...
        Objects.equals(this.sellerStructure, project.sellerStructure) &&
        Objects.equals(this.buyerStructure, project.buyerStructure) &&
        Objects.equals(this.validatorStructure, project.validatorStructure) &&
        Objects.equals(this.role, project.role) &&
        Objects.equals(this.process, project.process) &&
        Objects.equals(this.contractNumber, project.contractNumber) &&
        Objects.equals(this.marketNumber, project.marketNumber) &&
        Objects.equals(this.commitmentNumber, project.commitmentNumber) &&
        Objects.equals(this.effectiveDate, project.effectiveDate) &&
        Objects.equals(this.subcontractors, project.subcontractors) &&
        Objects.equals(this.jointcontractors, project.jointcontractors) &&
        Objects.equals(this.extraData, project.extraData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, label, type, customer, account, mainContact, entity, financialEntity, projectDirector, projectManager, opportunityManager, administrator, category, subCategory, productionStatus, invoicingMode, expenseManagementMode, paymentTerms, site, operation, mainProject, bank, analyticalCode, initialStartDate, initialEndDate, updatedStartDate, updatedEndDate, realStartDate, realEndDate, durationUnit, secondaryContacts, providedBy, description, comment, updatedBy, updatedOnTime, createdOnTime, managementCurrency, accountCurrency, reportingCurrency, planningMode, sellerStructure, buyerStructure, validatorStructure, role, process, contractNumber, marketNumber, commitmentNumber, effectiveDate, subcontractors, jointcontractors, extraData);
  }
  ...
  public String toString() {
    ...
    sb.append("    jointcontractors: ").append(toIndentedString(jointcontractors)).append("\n");
