...
@JsonPropertyOrder({
  ...
  Timesheet.JSON_PROPERTY_EMPLOYEE_FIRST_NAME,
  Timesheet.JSON_PROPERTY_EMPLOYEE_LAST_NAME
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, timesheet.id) &&
        ...
        Objects.equals(this.employeeFirstName, timesheet.employeeFirstName) &&
        Objects.equals(this.employeeLastName, timesheet.employeeLastName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, validationStep, employee, date, partialValidation, extraData, partialValid, expectedHours, expectedDays, canPartialValidation, lastComment, hasValidationHistory, access, weekDetails, noWorkDays, employeeFirstName, employeeLastName);
  }
