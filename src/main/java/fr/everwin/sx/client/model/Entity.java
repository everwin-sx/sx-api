...
public class Entity {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, businessName, isArchived, archivedDate, isAccounting, type, position, parent, accountingId, isAnalytical, phone, fax, vatNumber, accountCurrency, manageCurrency, reportCurrency, name);
  }
