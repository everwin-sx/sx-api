...
@JsonPropertyOrder({
  ...
  Entity.JSON_PROPERTY_DEFAULT_SELLER_STRUCTURE,
  Entity.JSON_PROPERTY_SELLER_STRUCTURES,
...
public class Entity {
  ...
  public static final String JSON_PROPERTY_DEFAULT_SELLER_STRUCTURE = "defaultSellerStructure";
  private SellerStructureDataLink defaultSellerStructure;

  public static final String JSON_PROPERTY_SELLER_STRUCTURES = "sellerStructures";
  private List<SellerStructureDataLink> sellerStructures;
  ...
  **/
  ...
  public Entity defaultSellerStructure(SellerStructureDataLink defaultSellerStructure) {
    this.defaultSellerStructure = defaultSellerStructure;
    return this;
  }

   /**
   * Get defaultSellerStructure
   * @return defaultSellerStructure
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DEFAULT_SELLER_STRUCTURE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public SellerStructureDataLink getDefaultSellerStructure() {
    return defaultSellerStructure;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_SELLER_STRUCTURE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultSellerStructure(SellerStructureDataLink defaultSellerStructure) {
    this.defaultSellerStructure = defaultSellerStructure;
  }


  public Entity sellerStructures(List<SellerStructureDataLink> sellerStructures) {
    this.sellerStructures = sellerStructures;
    return this;
  }

  public Entity addSellerStructuresItem(SellerStructureDataLink sellerStructuresItem) {
   ...
   /**
   * Link to the available seller structures of the entity (only for accounting entities). For more informations see the /seller-structures resource
  ...
  **/
  ...
  public List<SellerStructureDataLink> getSellerStructures() {
    return sellerStructures;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SELLER_STRUCTURES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSellerStructures(List<SellerStructureDataLink> sellerStructures) {
    this.sellerStructures = sellerStructures;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entity.id) &&
        ...
        Objects.equals(this.defaultSellerStructure, entity.defaultSellerStructure) &&
        Objects.equals(this.sellerStructures, entity.sellerStructures) &&
        Objects.equals(this.name, entity.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, businessName, isArchived, archivedDate, isAccounting, type, position, parent, accountingId, isAnalytical, phone, fax, vatNumber, accountCurrency, manageCurrency, reportCurrency, managers, defaultSellerStructure, sellerStructures, name);
  }
  ...
  public String toString() {
    ...
    sb.append("    defaultSellerStructure: ").append(toIndentedString(defaultSellerStructure)).append("\n");
