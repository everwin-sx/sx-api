...
public class TypeList {
  ...
  public TypeList types(List<Type> types) {
    this.types = types;
    return this;
  }

  public TypeList addTypesItem(Type typesItem) {
    if (this.types == null) {
  ...
  **/
  ...
  /**
   * Return true if this TypeList object is equal to o.
   */
  @Override
