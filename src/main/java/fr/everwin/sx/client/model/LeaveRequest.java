...
@JsonPropertyOrder({
  ...
  LeaveRequest.JSON_PROPERTY_CREATED_ON_TIME,
  LeaveRequest.JSON_PROPERTY_UPDATED_ON_TIME,
  LeaveRequest.JSON_PROPERTY_UPDATED_BY,
  LeaveRequest.JSON_PROPERTY_EMPLOYEE_FIRST_NAME,
  LeaveRequest.JSON_PROPERTY_EMPLOYEE_LAST_NAME,
...
public class LeaveRequest {
  ...
  public static final String JSON_PROPERTY_EMPLOYEE_FIRST_NAME = "employeeFirstName";
  private String employeeFirstName;

  public static final String JSON_PROPERTY_EMPLOYEE_LAST_NAME = "employeeLastName";
  ...
  public LeaveRequest(
    ...
    @JsonProperty(JSON_PROPERTY_EMPLOYEE_FIRST_NAME) String employeeFirstName, 
    @JsonProperty(JSON_PROPERTY_EMPLOYEE_LAST_NAME) String employeeLastName
  ) {
    this();
  ...
  **/
  ...
  public Boolean getHasValidationHistory() {
   ...
   /**
   * Date &amp; time of creation of the leave request
  ...
  **/
  ...
  public java.time.LocalDateTime getCreatedOnTime() {
   ...
   /**
   * Date &amp; time of the last update of the leave request
  ...
  **/
  ...
  public java.time.LocalDateTime getUpdatedOnTime() {
   ...
   /**
   * Login of the user doing the last update on the leave request
   * @return updatedBy
  **/
  @jakarta.annotation.Nullable
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EMPLOYEE_FIRST_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EMPLOYEE_LAST_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public LeaveRequest addExtraDataItem(SpecificData extraDataItem) {
   ...
   /**
   * Extra data of the leave request. For more information, see Extra data section
   * @return extraData
  **/
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, leaveRequest.id) &&
        ...
        Objects.equals(this.createdOnTime, leaveRequest.createdOnTime) &&
        Objects.equals(this.updatedOnTime, leaveRequest.updatedOnTime) &&
        Objects.equals(this.updatedBy, leaveRequest.updatedBy) &&
        Objects.equals(this.employeeFirstName, leaveRequest.employeeFirstName) &&
        Objects.equals(this.employeeLastName, leaveRequest.employeeLastName) &&
        Objects.equals(this.extraData, leaveRequest.extraData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, validationStep, code, employee, entity, type, startDate, startHalfDayIndicator, endDate, endHalfDayIndicator, duration, proofDocumentMandatory, hasProofDocument, employeeTimeCounter, estimatedBalanceAtDate, access, durationDetails, status, hasValidationHistory, createdOnTime, updatedOnTime, updatedBy, employeeFirstName, employeeLastName, extraData);
  }
