...
public class InvoicingGrid {
  ...
  private PaymentRequestDataLink paymentRequest;
  ...
  **/
  ...
  public InvoicingGrid paymentRequest(PaymentRequestDataLink paymentRequest) {
  ...
  **/
  ...
  public PaymentRequestDataLink getPaymentRequest() {
    return paymentRequest;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_REQUEST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPaymentRequest(PaymentRequestDataLink paymentRequest) {
    this.paymentRequest = paymentRequest;
  }
  ...
  **/
  ...
  public InvoicingGrid vat(VatDataLink vat) {
    this.vat = vat;
    return this;
  }
