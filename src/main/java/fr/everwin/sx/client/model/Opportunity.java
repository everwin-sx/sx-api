...
public class Opportunity {
  ...
  **/
  ...
  public Opportunity spanco(DataLink spanco) {
    this.spanco = spanco;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, label, customer, contributor, mainContact, secondaryContacts, entity, financialEntity, projectDirector, projectManager, opportunityManager, category, subCategory, commercialStatus, invoicingMode, site, salesCycle, salesStep, spanco, proposalAmount, signatureDate, initialStartDate, initialEndDate, estimatedProbability, calculatedProbability, estimatedCustomerBudget, responseDeadline, durationUnit, updatedBy, updatedOnTime, createdOnTime, managementCurrency, accountCurrency, reportingCurrency, extraData);
  }
