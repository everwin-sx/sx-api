...
public class ProfilesApi {
   ...
   */
  public Profile getById(Long id, String fields) throws ApiException {
   ...
   */
  public ApiResponse<Profile> getByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    return apiClient.invokeAPI("ProfilesApi.getById", localVarPath, "GET", localVarQueryParams, null,
  ...
  public ApiResponse<String> pingWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI("ProfilesApi.ping", "/profiles/ping", "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public ProfileList query(String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
   ...
   */
  public ApiResponse<ProfileList> queryWithHttpInfo(String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
    ...
    return apiClient.invokeAPI("ProfilesApi.query", "/profiles", "GET", localVarQueryParams, null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
