...
public class ParametersApi {
   ...
   */
  public ApplicationParameter getByName(String name) throws ApiException {
    return getByNameWithHttpInfo(name).getData();
  }
   ...
   */
  public ApiResponse<ApplicationParameter> getByNameWithHttpInfo(String name) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/parameters/{name}"
    ...
    return apiClient.invokeAPI("ParametersApi.getByName", localVarPath, "GET", new ArrayList<>(), null,
   ...
   * 
   * @param name name (required)
   * @param applicationParameter Parameter (required)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
