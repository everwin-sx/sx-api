...
import fr.everwin.sx.client.model.GeographicalArea;
import fr.everwin.sx.client.model.GeographicalAreaList;
...
public class GeographicalAreasApi {
  ...
  public GeographicalAreasApi() {
    this(Configuration.getDefaultApiClient());
  }

  public GeographicalAreasApi(ApiClient apiClient) {
   ...
   * @param id id (required)
   * @param fields fields (optional)
   * @return ApiResponse&lt;GeographicalArea&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<GeographicalArea> getByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/geographical-areas/{id}"
  ...
  /**
   * Test geographical area service
   * 
   * @return String
   * @throws ApiException if fails to make API call
   * @http.response.details
  ...
  /**
   * Get a geographical area collection
   * 
   ...
   * @param limit limit (optional)
   * @param fields fields (optional)
   * @return ApiResponse&lt;GeographicalAreaList&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
