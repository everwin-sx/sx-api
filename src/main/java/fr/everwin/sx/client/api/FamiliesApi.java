...
public class FamiliesApi {
   ...
   */
  public String getById(Long id, String fields) throws ApiException {
   ...
   */
  public ApiResponse<String> getByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    return apiClient.invokeAPI("FamiliesApi.getById", localVarPath, "GET", localVarQueryParams, null,
  ...
  public ApiResponse<Void> pingWithHttpInfo() throws ApiException {
    ...
    String localVarContentType = apiClient.selectHeaderContentType();
    String[] localVarAuthNames = new String[] {"api_key", "oauth"};
    return apiClient.invokeAPI("FamiliesApi.ping", "/families/ping", "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
   ...
   */
  public FamilyList query(String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
   ...
   */
  public ApiResponse<FamilyList> queryWithHttpInfo(String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
    ...
    return apiClient.invokeAPI("FamiliesApi.query", "/families", "GET", localVarQueryParams, null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
