...
public class CustomerOrderLinesApi {
  ...
  public CustomerOrderLinesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public CustomerOrderLinesApi(ApiClient apiClient) {
   ...
   * @param id id (required)
   * @param fields fields (optional)
   * @return ApiResponse&lt;CustomerOrderLine&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<CustomerOrderLine> getCustomerOrderLineByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/customer-order-lines/{id}"
