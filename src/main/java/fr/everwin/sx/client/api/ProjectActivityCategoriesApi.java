...
public class ProjectActivityCategoriesApi {
  ...
  public ProjectActivityCategoriesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ProjectActivityCategoriesApi(ApiClient apiClient) {
   ...
   * @param id id (required)
   * @param fields fields (optional)
   * @return ApiResponse&lt;ProjectActivityCategory&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<ProjectActivityCategory> getByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/project-activity-categories/{id}"
