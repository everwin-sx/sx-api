...
public class CompaniesStatusApi {
  ...
  public CompaniesStatusApi() {
    this(Configuration.getDefaultApiClient());
  }

  public CompaniesStatusApi(ApiClient apiClient) {
  ...
  public ApiResponse<Statut> getStatusByIdWithHttpInfo(Long id) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/company-status/{id}"
   ...
   */
  public Statut queryDefaultCustomer() throws ApiException {
    return queryDefaultCustomerWithHttpInfo().getData();
  }
   ...
   */
  public ApiResponse<Statut> queryDefaultCustomerWithHttpInfo() throws ApiException {
    String localVarAccept = apiClient.selectHeaderAccept("application/json;charset=utf-8");
    String localVarContentType = apiClient.selectHeaderContentType();
    String[] localVarAuthNames = new String[] {"api_key", "oauth"};
    GenericType<Statut> localVarReturnType = new GenericType<Statut>() {};
    return apiClient.invokeAPI("CompaniesStatusApi.queryDefaultCustomer", "/company-status/default-customer", "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public Statut queryDefaultSupplier() throws ApiException {
    return queryDefaultSupplierWithHttpInfo().getData();
  }
   ...
   */
  public ApiResponse<Statut> queryDefaultSupplierWithHttpInfo() throws ApiException {
    String localVarAccept = apiClient.selectHeaderAccept("application/json;charset=utf-8");
    String localVarContentType = apiClient.selectHeaderContentType();
    String[] localVarAuthNames = new String[] {"api_key", "oauth"};
    GenericType<Statut> localVarReturnType = new GenericType<Statut>() {};
    return apiClient.invokeAPI("CompaniesStatusApi.queryDefaultSupplier", "/company-status/default-supplier", "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
