...
public class PoaQuotesApi {
  ...
  public PoaQuotesApi(ApiClient apiClient) {
  ...
  public ApiResponse<Void> addPOAQuoteEstimateToOrderWithHttpInfo(Long orderId, Long estimateId, CustomerOrder customerOrder) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quotes/{estimateId}/order/{orderId}"
  ...
  public ApiResponse<Void> createPOAQuoteOrderFromEstimateWithHttpInfo(Long estimateId, CustomerOrder customerOrder) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quotes/{estimateId}/order"
            .replaceAll("\\{estimateId}", apiClient.escapeString(estimateId.toString()));
   ...
   */
  public POAQuoteItemList getItems(Long id, String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
    return getItemsWithHttpInfo(id, filter, sort, offset, limit, fields).getData();
  }
   ...
   */
  public ApiResponse<POAQuoteItemList> getItemsWithHttpInfo(Long id, String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
    // Check required parameters
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getItems");
    }

    // Path parameters
    String localVarPath = "/poa-quotes/{id}/items"
            .replaceAll("\\{id}", apiClient.escapeString(id.toString()));
    ...
    return apiClient.invokeAPI("PoaQuotesApi.getItems", localVarPath, "GET", localVarQueryParams, null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
  ...
  public ApiResponse<POAQuoteLineList> getPOAQuoteLinesWithHttpInfo(Long id, String filter, String sort, Integer offset, Integer limit, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quotes/{id}/lines"
            .replaceAll("\\{id}", apiClient.escapeString(id.toString()));
  ...
  public ApiResponse<Void> validatePOAQuoteWithHttpInfo(Long id, String step) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quotes/{id}/validate"
            .replaceAll("\\{id}", apiClient.escapeString(id.toString()));

    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
            apiClient.parameterToPairs("", "step", step)
    );
