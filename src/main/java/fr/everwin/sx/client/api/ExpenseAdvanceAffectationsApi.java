...
import fr.everwin.sx.client.model.AdvanceAffectation;
import fr.everwin.sx.client.model.AdvanceAffectationList;
...
public class ExpenseAdvanceAffectationsApi {
  ...
  public ExpenseAdvanceAffectationsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ExpenseAdvanceAffectationsApi(ApiClient apiClient) {
  ...
  /**
   * Get a advance affectation by id
   * 
   * @param id id (required)
   * @param fields fields (optional)
   * @return AdvanceAffectation
   ...
   * @param id id (required)
   * @param fields fields (optional)
   * @return ApiResponse&lt;AdvanceAffectation&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<AdvanceAffectation> getAdvanceAffectationByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/expense-advance-affectations/{id}"
  ...
  /**
   * Test advance affectations service
   * 
   * @return String
   * @throws ApiException if fails to make API call
   * @http.response.details
  ...
  /**
   * Get a advance affectations collection
   * 
   ...
   * @param limit limit (optional)
   * @param fields fields (optional)
   * @return ApiResponse&lt;AdvanceAffectationList&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
