...
public class PoaQuoteLinesApi {
  ...
  public PoaQuoteLinesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public PoaQuoteLinesApi(ApiClient apiClient) {
  ...
  public ApiResponse<Void> addPOAQuoteLineToOrderWithHttpInfo(Long orderId, Long estimateLineId, CustomerOrder customerOrder) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quote-lines/{estimateLineId}/order/{orderId}"
   ...
   * @param id id (required)
   * @param fields fields (optional)
   * @return ApiResponse&lt;PoaquoteLine&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<PoaquoteLine> getPOAQuoteLineByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/poa-quote-lines/{id}"
   ...
   * 
   * @param id id (required)
   * @param writablePoaquoteLine line (required)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
