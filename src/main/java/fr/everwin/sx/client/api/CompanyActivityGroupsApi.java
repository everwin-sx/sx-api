...
import fr.everwin.sx.client.model.NaceGroupList;
...
public class CompanyActivityGroupsApi {
  ...
  public CompanyActivityGroupsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public CompanyActivityGroupsApi(ApiClient apiClient) {
  ...
  /**
   * Get a company activity group by id
   * 
  ...
  public ApiResponse<NaceGroup> getByIdWithHttpInfo(Long id, String fields) throws ApiException {
    ...
    // Path parameters
    String localVarPath = "/company-activity-groups/{id}"
  ...
  /**
   * Test company activity group service
   * 
   * @return String
   * @throws ApiException if fails to make API call
   * @http.response.details
  ...
  /**
   * Get a company activity group collection
   * 
   ...
   * @param limit limit (optional)
   * @param fields fields (optional)
   * @return ApiResponse&lt;NaceGroupList&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
