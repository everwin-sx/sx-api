...
/**
 * Model tests for ProjectCategories
 */
public class ProjectCategoriesTest {
    private final ProjectCategories model = new ProjectCategories();
