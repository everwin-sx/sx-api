 ...
 * @author d.storti
 */
public class CompanyActivityGroupTest extends BasicTest<NaceGroup, NaceGroupService> {

    @Override
    @BeforeClass
    public void setUp() {
        super.setUp();
        service = new NaceGroupService(clientApi);
        ws_rights = "R";
    }
    ...
    @Override
    protected NaceGroup initObject() {
        return new NaceGroup();
    }
