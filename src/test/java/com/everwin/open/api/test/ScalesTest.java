...
import fr.everwin.open.api.services.expenses.ScaleService;
 ...
 * @author d.storti
 */
public class ScalesTest extends BasicTest<Scale, ScaleService> {

	@Override
	@BeforeClass
	public void setUp() {
		super.setUp();
		service = new ScaleService(clientApi);
		ws_rights = "R";
	}
