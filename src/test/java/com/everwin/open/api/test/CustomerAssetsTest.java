 ...
 * @author d.storti
 */
public class CustomerAssetsTest extends BasicTest<CustomerAsset, CustomerAssetsService> {

	@Override
	@BeforeClass
	public void setUp() {
		super.setUp();
		service = new CustomerAssetsService(clientApi);
		ws_rights = ""; //R
	}
	...
	@Override
	protected CustomerAsset initObject() {
