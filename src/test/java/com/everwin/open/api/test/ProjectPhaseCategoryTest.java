 ...
 * @author d.storti
 */
public class ProjectPhaseCategoryTest extends BasicTest<ProjectPhaseCategory, ProjectPhaseCategoryService> {

	@Override
	@BeforeClass
	public void setUp() {
		super.setUp();
		service = new ProjectPhaseCategoryService(clientApi);
		ws_rights = "R";
	}
	...
	@Override
	protected ProjectPhaseCategory initObject() {
		return new ProjectPhaseCategory();
	}
